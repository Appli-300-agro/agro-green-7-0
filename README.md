# AGRO GREEN 7.0 - Plateforme Web E-commerce

Bienvenue sur le dépôt du code source de l'application web **AGRO GREEN 7.0**. Ce projet est une solution complète (Site Vitrine + E-commerce + Administration) développée avec des technologies modernes pour assurer performance et évolutivité.
...
| :--- | :--- | :--- | :--- |
| **Administrateur** | `admin@agrogreen70.cm` | `admin123` | **OTP : 2025** |
| **Utilisateur** | `user@agrogreen70.cm` | `user123` | |
...
*   **Contact :** contact@agrogreen70.cm